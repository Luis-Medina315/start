...
export function ProductDrawer({ open, onClose, editingProduct }: Props) {
    ...
    <>
      ...
      <aside className="fixed right-0 top-0 h-full w-full max-w-md bg-white shadow-2xl z-50 flex flex-col animate-slide-in">
        ...
        >
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full border border-zinc-300 rounded-lg px-3 py-2.5 text-sm text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent"
            />
          </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="0.00"
                  className="w-full border border-zinc-300 rounded-lg pl-7 pr-3 py-2.5 text-sm text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent"
                />
              </div>
            </div>
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="Tandil, Pasta dura, Azul..."
              className="w-full border border-zinc-300 rounded-lg px-3 py-2.5 text-sm text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent"
            />
          </div>
        ...
        <div className="px-6 py-4 border-t border-zinc-200 bg-zinc-50 flex gap-3">
          ...
          >
            {submitting ? "Guardando…" : isEditing ? "Guardar cambios" : "Agregar producto"}
          </button>
        </div>

        <form id="product-form" onSubmit={onSubmit} className="hidden" />
      </aside>
